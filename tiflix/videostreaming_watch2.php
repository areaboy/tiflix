...
.follow_css { 
color: #fff; display: block; float: right; border-radius: 12px;  background: #B931B9; padding:6px;font-size:14px;
cursor:pointer;
 }
...
.follow_css1 { 
color: #fff; display: block; border-radius: 12px;  background: #B931B9; padding:6px;font-size:16px;
cursor:pointer;
 }
...
title="<?php echo $title; ?>"
  ...
  <img src='file.png' alt='<?php echo $title; ?>' />
