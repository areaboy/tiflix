...
<li class="navbar-brand home_click imagelogo_li_remove" ><img title='<?php  echo $title; ?>-logo' alt='<?php  echo $title; ?>-logo' class="img-rounded imagelogo_data" src="<?php echo $logo; ?>"></li>
 ...
 <li class="navgate_no"><a href="<?php echo $site_url; ?>/dashboard_settings.php" title='Settings'  style="color:white;font-size:14px;">
<button class="category_post1">Settings</button></a></li>



 <li class="navgate_no"><a href="<?php echo $site_url; ?>/installations.php" title='Installations'  style="color:white;font-size:14px;display:none;">
<button class="category_post1">Installations</button></a></li>



 <li class="navgate_no"><a href="<?php echo $site_url; ?>/admin_videos.php" title='Upload & Manage Video Posts'  style="color:white;font-size:14px;">
<button class="category_post1">Upload & Manage <br> Videos</button></a></li>



 <li class="navgate_no"><a href="<?php echo $site_url; ?>/admin_payments.php" title='Manage Payments'  style="color:white;font-size:14px;">
<button class="category_post1">Manage <br>Payments</button></a></li>

 <li class="navgate_no"><a href="<?php echo $site_url; ?>/admin_statistics.php" title='Statistics'  style="color:white;font-size:14px;">
<button class="category_post1">Statistics</button></a></li>
...
<span style='display:none;'><?php echo $fullname_sess; ?></span></a>
</span>
...
// confirm start
 if(confirm("Are you sure you want to Ban this User from Login into this Application: ")){
...
$("#loader-v_"+id).fadeIn(400).html('<br><div style="color:black;background:white;padding:10px;"><img src="ajax-loader.gif"> &nbsp;Please Wait, User is being Verified...</div>');
var datasend = {'id': id, 'userid': userid};
		$.ajax({
			
			type:'POST',
			url:'user_verified.php',
			data:datasend,
                        crossDomain: true,
			cache:false,
			success:function(msg){
...
<center><h3>Manage Users/Subscribers</h2><br>
